...
def test_sample_1(framework, group_name, test_name):
    TEST_INFO_MESSAGE("Running Sample Test 1")
    TEST_ASSERT_EQUAL(2,2)

def test_sample_2(framework, group_name, test_name):
    TEST_INFO_MESSAGE("Running Sample Test 2")
    TEST_ASSERT_EQUAL ("abc".upper(), "ABC")

def test_sample_3(framework, group_name, test_name):
    TEST_INFO_MESSAGE("Running Sample Test 3")
    TEST_ASSERT_EQUAL(123, int)
